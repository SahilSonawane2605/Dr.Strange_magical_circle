...
# Set a larger capture resolution for bigger frames
video.set(cv2.CAP_PROP_FRAME_WIDTH, 1911)
video.set(cv2.CAP_PROP_FRAME_HEIGHT, 1136)

img_1 = cv2.imread('Doctor Strange Filter\magic_circles\magic_circle_ccw.png', -1)
img_2 = cv2.imread('Doctor Strange Filter\magic_circles\  magic_circle_cw.png', -1)
